...
4. **Extracción (60 s).** Borrador con evidencia citada, marca atribuida al tomógrafo (no a rayos X), cantidad 2 para rayos X. Pregunta de seguimiento sobre ciudad o cantidad (no marca). **Responderla en el campo y clic en "Agregar dato"**: el transcript se re-extrae y el faltante desaparece. Latencia visible (< 2 s). Explicar: schema estricto + blindaje que anula lo no literal y ancla marca/edad a la modalidad correcta.
